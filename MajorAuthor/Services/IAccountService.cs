...
namespace MajorAuthor.Services
{
    ...
    public interface IAccountService
    {
        ...
        Task<ExternalLoginCallbackResult> HandleExternalLoginCallbackAsync(ExternalLoginInfo info, string returnUrl);
        ...
        Task<IdentityResult> AutoCreateExternalUserAsync(ExternalLoginInfo info);
        Task<IdentityResult> ResetPasswordAsync(ResetPasswordViewModel model);
        Task<ExternalLoginJsonResult> CompleteExternalRegistrationAsync(string email, ExternalLoginTempData tempData, string callbackUrl);
    }
}